...
// 橋(2点間を結ぶ歩行可能な直線通路)
const BRIDGES = [
  { id:'lakeside', name:'レイクサイドブリッジ', a:{x:-100,z:-140}, b:{x:-130,z:0},  w:8 },
  { id:'center',   name:'センターブリッジ',     a:{x:104,z:0},     b:{x:340,z:-160}, w:8 },
  { id:'forest',   name:'フォレストブリッジ',   a:{x:-100,z:-220}, b:{x:340,z:-280}, w:8 },
];
